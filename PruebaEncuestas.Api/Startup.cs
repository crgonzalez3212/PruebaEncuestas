...
using PruebaEncuestas.Infrastructure.Repositories;
using System;
...
namespace PruebaEncuestas.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PruebaEncuestaContext>(options =>
            options.UseSqlServer(Configuration.GetConnectionString("EncuestaPrueba")));
